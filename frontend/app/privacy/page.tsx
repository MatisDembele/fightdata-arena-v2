      ...
      <main style={{ padding: '48px 24px 80px', minHeight: 'calc(100vh - 60px)' }}>
        <div style={{ maxWidth: '680px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '32px' }}>
          ...
          <div>
            ...
            <div style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: '0.48rem', letterSpacing: '3px', color: 'rgba(255,255,255,0.25)', marginTop: '6px' }}>
...
Pour toute demande : dembelematis@gmail.com`,
            ...
            <div key={title} style={{ borderLeft: '2px solid rgba(88,101,242,0.4)', paddingLeft: '20px' }}>
              <div style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: '0.52rem', letterSpacing: '3px', color: '#5865F2', marginBottom: '10px' }}>{title}</div>
              <div style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: '0.48rem', letterSpacing: '1px', color: 'rgba(255,255,255,0.5)', lineHeight: 1.9, whiteSpace: 'pre-line' }}>{body}</div>
            </div>
          ))}

          <div style={{ marginTop: '8px' }}>
            <Link href="/" style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: '0.48rem', letterSpacing: '2px', color: 'rgba(255,255,255,0.3)', textDecoration: 'none' }}>
              ← RETOUR À L'ACCUEIL
            </Link>
          </div>
