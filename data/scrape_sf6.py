...
SF6_ROSTER = [
    "ryu", "luke", "jamie", "chun-li", "guile", "kimberly",
    "juri", "ken", "blanka", "dhalsim", "ehonda", "dee-jay",
    "manon", "marisa", "jp", "zangief", "lily", "campy",
...
def _parse_move(container, section: str, slug: str, download_gifs: bool) -> dict | None:
    ...
    if hitbox_div:
        ...
        if img and img.get("src"):
            src = img["src"].lstrip("/")           # "hitboxes/akuma/akuma-st-lp.gif"
